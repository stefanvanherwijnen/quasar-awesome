...
| [auth-token-based](https://github.com/stefanvanherwijnen/quasar-app-extension-auth-token-based) | Token based authentication using the Vuex store with basic login, register and password reset pages. |
